	...
	$.fn.zyComment = function(options,param){
		...
		return this.each(function(){
			...
			this.createAgoCommentHtml = function(){
				...
				html += '	<div class="text" style="font-size:2rem;padding-bottom:10px;border-bottom: 1px solid #DFDFDF;"> 给我留个言吧 </div>';
				html += '</div>';
				$(self).append(html);
				...
				$.each(para.agoComment, function(k, v){
					...
					item += '	<a class="avatar">';
					item += '		<img src="style/images/images_jmember_pl/foot.png">';
					item += '	</a>';
